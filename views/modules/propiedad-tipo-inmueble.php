...
$cat->GuardarTipoInmuebleController();

 
$cat->EditarTipoInmuebleController();
$cat->BorrarTipoInmuebleController();


 ?>
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Categoría de tipo de inmueble</h2>
                   <ol class="breadcrumb">
                        <li>
            ...
            <div class="ibox float-e-margins">
                   ...
                   <form id="form1" role="form" class="form-inline" name="form1" method="post" action="" require> 
                            <div class="form-group">
                                <label for="" class="">Agregar tipo</label>
                    ...
                    <?php 
                     $cat->ListaTipoInmuebleController();
                     ?> 
                     </ul>
