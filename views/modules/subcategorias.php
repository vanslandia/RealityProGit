...
$lista->DeleteSubCategoriasController();
$lista->PublicarSubCategoriasController();
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins"  style="padding-bottom: 0px; margin-bottom: 0px;">
                    <div class="ibox-title">
                        <h5>Subcategorías en la plataforma. </h5>
                          <div class="ibox-tools sr-only">
                         ...
                         <form method="post" name="addUsuario1" id="addUsuario1" class="form-horizontal" >   
                                <div class="form-group"> 
                                             <div class="col-md-3 sr-only " id="data_5">                                   
                                                ...
                                                <div class="col-md-3 " > 
                                                    <input type="text" name="nombre" id="nombre" value="<?php if(isset($_POST["nombre"]))echo $_POST["nombre"];?>"  autocomplete="off"  class=" form-control" placeholder="Que desea buscar?" required> 
                                                </div> 
                ...
                <div class="ibox-content">
                    ...
                    <?php
                     ...
                     $lista->ListSubCategoriasController();
