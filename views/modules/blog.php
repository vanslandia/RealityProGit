...
$blog->PublicarArticulosController();
$blog->EditarArticulosController();
$blog->BorrarArticulosController();
...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                   ...
                   <ol class="breadcrumb">
                        <li>
                            Artículos alojados en el sistema
                        </li> 
                    </ol>
                </div> 
</div>
        ...
        <div class="col-lg-12 ">
            <div class="ibox float-e-margins">
                   ...
                   <form id="form1" role="form" class="form-inline" name="form1" method="post" action="" onsubmit="validarBitacora();return document.validado"> 
                    ...
                    <?php   if($res=="success")echo '<div class="alert alert-info alerta text-center">Se han guardado los cambios.</div>';  ?>
                    <div class="ibox-content" id="articulos">
					<div id="editarArticulo">
                        <div class="row">
                                <?php 
                                 $blog->ListaArticulosController();
                                 ?> 
                          </div> <!-- row -->
                     </div>
