...
$dat = $prod->GetProductoController();

?>
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><?php echo $dat["nombre"]; ?></h2>
                   <ol class="breadcrumb">
                        <li>
                             Edite la galería de imagenes de este producto
                        </li> 
                    </ol>
            ...
            <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">                               
                                <a href="index.php?bq=productos-dat&id=<?php echo PasarNumero($dat["id"]); ?>"> <div type="button" class="btn btn-default btn-xs  text-navy ">Regresar</div>  </a>
                         </div>
					...
					<ul id="galeriaProducto" data="<?php echo $dat["id"]; ?>" data-url="<?php echo $_GET["id"];?>"> 
						...
						$prod->ListaGaleriaProductoControllers(); 
            ...
            <div class="ibox float-e-margins">
                    ...
                    <div  id="textoSlide"  class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    	...
                    	<ul id="ordenarTextSlide"  data-url="<?php echo $_GET["id"];?>">
							<?php   
							$prod->ListaEditGaleriaProductoControllers();  
							?>  
						</ul>
