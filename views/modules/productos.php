...
$lista->DeleteProductoController();
$lista->PublicarProductoController();
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins"  style="padding-bottom: 0px; margin-bottom: 0px;">
                    <div class="ibox-title">
                        <h5>Productos en la plataforma. <small>Se muestran los últimos 30</small></h5>
                    ...
                    <div class="ibox-content ibox-heading" <?php if(empty($_POST["buscar"])) echo 'style="display:none"';  ?> >
                         ...
                         <form method="post" name="addUsuario1" id="addUsuario1" class="form-horizontal" >   
                                <div class="form-group"> 
                                             <div class="col-md-3 sr-only " id="data_5">                                   
                                                <div class="input-group-date" style="position:absolute;"> 
                                                    <div class="input-daterange input-group" id="datepicker"  > 
                                                     ...
                                                     <small class="text-gray">Fecha ingreso</small>
                                                </div>  
                                              </div> <!--  --> 
                                                <div class="col-md-3 " > 
                                                ...
                                                <div class="col-md-2 " > 
                                                     <div class="i-checks"><label> <input type="checkbox" id="nuevos" name="nuevos" value="true" <?php if(isset($_POST["nuevos"]))echo "checked";?> ><i></i> Productos Nuevos </label></div>
                                                </div>
                                                <div class="col-md-2 " > 
                                                     <div class="i-checks"><label> <input type="checkbox" id="ofertas" name="ofertas" value="true" <?php if(isset($_POST["ofertas"]))echo "checked";?> ><i></i> Ofertas </label></div>
                                                </div>
                                                <div class="col-md-2 " > 
                                                     <div class="i-checks"><label> <input type="checkbox"  id="inactivos" name="inactivos" value="true" <?php if(isset($_POST["inactivos"]))echo "checked";?> ><i></i> Inactivos </label></div>
                                                </div>
