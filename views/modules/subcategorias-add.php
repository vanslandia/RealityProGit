...
$add->GuardarSubCategoriasController(); 
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label"  >Subcategoría</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="subcategoria" id="subcategoria"  class="form-control"  autocomplete="off" ></div>
                                </div>
