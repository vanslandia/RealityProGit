...
$add->UpdateCategoriasController();
$dat = $add->GetCategoriasController();
...
?>
 ...
 <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Editar de categoría  - <?php echo $dat["categoria"];?></h2> 
                </div>
                <div class="col-lg-2">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label"  >Portada</label>
                                    <div class="col-sm-8"><p class="static-form-control"> <img src="<?php echo $thumb;?>"      class="img-gd img-rounded " style="max-width: 80%;"> </p> </div>
                                </div>
                                 <div class="form-group"><label class="col-sm-2 control-label"  >Categoría</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="categoria" id="categoria" value="<?php echo $dat["categoria"];?>"  class="form-control"  autocomplete="off" ></div>
                                </div>
