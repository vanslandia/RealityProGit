...
class CrudSlideAjax{ 
	...
	public function Upload(){
		...
		$datos = array("nombre"=>$this->imagen, "temporal"=>$this->temp, "articulo"=>$this->articulo); 
		$respuesta = articulosController::MostrarImg($datos);
		echo  $respuesta; 
	}
	...
	public function EliminarImgApp(){ 
		...
		$respuesta = articulosController::EliminarImgArtController($this->delete);
		echo $respuesta; 
	}
	...
	function UpdateSlide(){
		...
		$respuesta = articulosController::EditGaleriaController($datos);
		echo $respuesta;
	}
	...
	public function UpdateOrder(){
		...
		articulosController::OrdenImgArtController($datos);
	}
