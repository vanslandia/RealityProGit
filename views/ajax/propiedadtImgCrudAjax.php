...
class CrudSlideAjax{ 
	...
	public function Upload(){
		...
		$respuesta = inmuebleController::MostrarImg($datos);
		echo  $respuesta; 
	}
	...
	public function EliminarImgApp(){ 
		...
		$respuesta = inmuebleController::EliminarImgInmuebController($this->delete);
		echo $respuesta; 
	}
	...
	function UpdateSlide(){
		...
		$respuesta = inmuebleController::EditGaleriaController($datos);
		echo $respuesta;
	}
	...
	public function UpdateOrder(){
		...
		inmuebleController::OrdenImgInmuebController($datos);
	}
