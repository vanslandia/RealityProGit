...
$dat = $page->GetCategoryController();
//var_dump($dat);
 ...
 <div id="inSlider" class="carousel carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
                <div class="item active">
                            ...
                            <div class="header-back " style="background: url(../<?php echo $dat["imagen"];?>) 50% 0 no-repeat;"></div>
                        </div>
    </div>
     <!-- 
 ...
 <?php  $page->GetDinamicSectionSubCategoriasController($dat["id"]); ?>
